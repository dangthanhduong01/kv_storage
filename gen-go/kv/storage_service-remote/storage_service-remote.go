...
func main() {
  ...
  client := kv.NewStorageServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "putData":
    ...
    err73 := argvalue1.Read(context.Background(), jsProt72)
    if err73 != nil {
      Usage()
      return
    }
  ...
  case "getListData":
    ...
    err79 := containerStruct0.ReadField1(context.Background(), jsProt78)
    if err79 != nil {
      Usage()
      return
    }
  ...
  case "putMultiData":
    ...
    err86 := containerStruct0.ReadField1(context.Background(), jsProt85)
    if err86 != nil {
      Usage()
      return
    }
